...
def init_db():
    ...
    if cur.fetchone()[0] == 0:
        seed = [
            ...
            ("Baby swing", "Para mecer y calmar a Isaac.", "Dormir", 0, "🪑", "baby_swing.jpg", 1),
            ("Cesta de ropa sucia para bebé", "Para mantener la ropita de Isaac organizada.", "Cuidado", 0, "🧺", "cesta_ropa.jpg", 1),
            ("Cámara monitor", "Para vigilar a Isaac desde cualquier lugar.", "Cuidado", 0, "📷", "camara_monitor.jpg", 1),
            ...
            ("Monitoreo de bebé", "Para monitorear la respiración y el sueño de Isaac.", "Cuidado", 0, "📟", "monitoreo_bebe.jpg", 1),
            ("Teteros / limpiador de teteros", "Kit de teteros y limpiador.", "Alimentación", 65, "🍼", "teteros.jpg", 1),
            ("Almohada de lactancia", "Para hacer más cómoda la hora de la lactancia.", "Alimentación", 0, "🤱", "almohada_lactancia.jpg", 1),
            ("Organizador de gavetas", "Para ordenar la ropita de Isaac en las gavetas.", "Dormir", 0, "🗂️", "organizador_gavetas.jpg", 1),
            ("Esterilizador de teteros", "Para esterilizar los teteros de Isaac.", "Alimentación", 0, "♨️", "esterilizador.jpg", 1),
            ("Calentador de leche", "Para calentar la leche a la temperatura ideal.", "Alimentación", 0, "🍶", "calentador_leche.jpg", 1),
        ]
